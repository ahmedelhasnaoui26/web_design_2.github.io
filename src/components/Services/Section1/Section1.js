        ...
        <div>
            <div className={styles.header}>
                ...
                <div className={styles.title}>
                    <h4 className={styles.h4}>Just a smile away from<br />
                        <span className={styles.span}>Winning your customer’s trust</span></h4>
                </div>

            </div>
            <div className={styles.part2}>
                <section className={styles.section}>
                    <h4 className={styles.h44}>Our Service</h4>
